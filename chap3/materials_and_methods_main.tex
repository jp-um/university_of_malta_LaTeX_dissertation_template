...
\section{An Example of a Subsection and Subsubsection}
...
\section{An Example Using Acronyms}
...
A beautiful table is shown in Table~\ref{tab:sometable}, data from \cite{Ebejer2012} (when citing as part of text, otherwise use parentheses \cite{Ebejer2012} version).
...
\section{An Example of a Landscape Table}
...
\section{An Example of a Theorem}
...
\section{An Example of a Code Listing}
...
\section{An Example of an Algorithm}
...
\section{An Example of Referencing (In- and Out- Text)}

In their study, \cite{einsteen} show the world is round. Others have shown this to be the case \cite{Arrighi2003, WithersMartinez2012}.
