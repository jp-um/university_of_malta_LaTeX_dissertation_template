...
\title{Blockchain Approaches\\to Machine Learning}  % use \\ here otherwise you get a justified title
                                                    % note capitalization of the title (only common 
                                                    % words in lower case)
\tagline{some hyped-up tagline}                     % tag line
\author{Jean-Paul Ebejer}                           % your name
\supervisor{Dr Supervisor(s)}                       % your supervisor(s) name - no . in Dr
\department{Department of AI}                       % your department 
\faculty{Faculty of ICT}                            % your faculty
\degree{M.Sc.\ Big-Data \& AI}                      % the degree you are reading
\doctype{dissertation}                              % when did you submit
\degreedate{June, 2018}                             % when did you submit
